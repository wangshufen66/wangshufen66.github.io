...
![image-20220614125001525](C:\Users\15640\AppData\Roaming\Typora\typora-user-images\image-20220614125001525.png)
...
- 容器转为镜像
  ...
  ![image-20220901153412166](/Users/wayne_wang1/Library/Application Support/typora-user-images/image-20220901153412166.png)
...
| WORKDIR(=cd) | 工作目录                 | 指定容器内部的工作目录 如果没有创建则自动创建 如果指定/使用是绝对地址 如果不是/开头那么实在上一条workdir 的路径的相对路径 |
